...
| `DocumentTranslationsMiddlewareTest` | Email regex matching, session flag management, edge cases (no header, invalid regex, boolean modes) |
| `DocTranslationHelperTest` | `_is_doc_translation_possible` / `_is_doc_translation_enabled` tri-state logic |
